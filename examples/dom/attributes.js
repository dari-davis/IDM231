(function() {
  ...
  const hotOne = document.getElementsByTagName('li');
  console.log(hotOne);

  //console.log(hotOne[1]).getAttribute('class');
  console.log(hotOne[2]).getAttribute('class');
  console.log(hotOne[2]).setAttribute('class', 'pizza');
